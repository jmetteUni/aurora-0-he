...
switch Vname
    ...
    case 'wave_time'
        ...
        %--------------------------------------------------------------------------
        %  Bottom heat and salt flux
        %--------------------------------------------------------------------------    
    case 'bhf_time'
        V.Name                    = Vname;
        V.Dimensions(1).Name      = 'bhf_time';
        V.Dimensions(1).Length    = [];
        V.Dimensions(1).Unlimited = Unlimited;
        V.Size                    = [];
        V.Attributes(1).Name      = 'long_name';
        V.Attributes(1).Value     = 'bottom heat flux time';
        V.Attributes(2).Name      = 'units';
        V.Attributes(2).Value     = 'day';
        V.Cgridtype.Name          = 'none';
        V.Cgridtype.Value         = 0;
    ...
    case 'bwf_time'
        V.Name                    = Vname;
        V.Dimensions(1).Name      = 'bwf_time';
        V.Dimensions(1).Length    = [];
        V.Dimensions(1).Unlimited = Unlimited;
        V.Size                    = [];
        V.Attributes(1).Name      = 'long_name';
        V.Attributes(1).Value     = 'bottom salt flux time';
        V.Attributes(2).Name      = 'units';
        V.Attributes(2).Value     = 'day';
        V.Cgridtype.Name          = 'none';
        V.Cgridtype.Value         = 0;
    ...
    case 'bhflux'
        ...
        V.Dimensions(2).Length    = [];
        V.Dimensions(2).Unlimited = false;
        V.Dimensions(3).Name      = 'bhf_time';
        V.Dimensions(3).Length    = [];
        V.Dimensions(3).Unlimited = Unlimited;
        V.Size                    = [];
        V.Attributes(1).Name      = 'long_name';
        V.Attributes(1).Value     = 'bottom net heat flux';
        V.Attributes(2).Name      = 'units';
        V.Attributes(2).Value     = 'watt meter-2';
        V.Attributes(3).Name      = 'time';
        V.Attributes(3).Value     = 'bhf_time';
        V.Attributes(4).Name      = 'coordinates';
        V.Attributes(4).Value     = 'lon lat bhf_time';
        V.Cgridtype.Name          = 'density point';
        V.Cgridtype.Value         = 1;
        V.Datatype                = Datatype;
        V.ncType                  = nc_constant(nctype);        
    case 'bwflux'
        ...
        V.Dimensions(2).Length    = [];
        V.Dimensions(2).Unlimited = false;
        V.Dimensions(3).Name      = 'bwf_time';
        V.Dimensions(3).Length    = [];
        V.Dimensions(3).Unlimited = Unlimited;
        V.Size                    = [];
        V.Attributes(1).Name      = 'long_name';
        V.Attributes(1).Value     = 'bottom net salt flux';
        V.Attributes(2).Name      = 'units';
        V.Attributes(2).Value     = 'centimeter day-1';
        V.Attributes(3).Name      = 'time';
        V.Attributes(3).Value     = 'bwf_time';
        V.Attributes(4).Name      = 'coordinates';
        V.Attributes(4).Value     = 'lon lat bhf_time';
        V.Cgridtype.Name          = 'density point';
        V.Cgridtype.Value         = 1;
    ...
    case {'dye_01', 'dye_02', 'dye_03', 'dye_04',                         ...
        ...
        %--------------------------------------------------------------------------
        %  Inert passive tracer bottom flux variables.
        %--------------------------------------------------------------------------
        
    case {'dye_01_bflux', 'dye_02_bflux', 'dye_03_bflux', 'dye_04_bflux',                         ...
            'dye_05_bflux', 'dye_06_bflux', 'dye_07_bflux', 'dye_08_bflux'}
        class = textscan(Vname, 'dye_ %d');
        V.Name                    = Vname;
        V.Dimensions(1).Name      = 'lon';
        V.Dimensions(1).Length    = [];
        ...
        V.Size                    = [];
        V.Attributes(1).Name      = 'long_name';
        V.Attributes(1).Value     = ['dye bottom flux, ',                 ...
            num2str(class{:}, '%2.2i')];
        V.Attributes(2).Name      = 'units';
        V.Attributes(2).Value     = 'kilogram meter-3 meter sec-1';
        V.Attributes(3).Name      = 'time';
        V.Attributes(3).Value     = 'ocean_time';
        V.Attributes(4).Name      = 'coordinates';
        if (spherical),
